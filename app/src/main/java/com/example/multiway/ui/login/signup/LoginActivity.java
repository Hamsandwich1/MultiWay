...
import androidx.annotation.NonNull; // Makes sure that the log in fields need a value
import androidx.appcompat.app.AppCompatActivity;
import com.example.multiway.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               if (!validateUsername() | !validatePassword()){ //Makes sure that passwords and usernames are correct
